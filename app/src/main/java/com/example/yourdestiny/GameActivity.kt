...
class GameActivity : AppCompatActivity() {
    ...
    fun clickOnNextText(view: View) {
        ...
        if (textViewText.text == "Наша история начинается с молодого Стража на космодроме в России в космическом костюме с небольшим вооружением.\nК нему подлетает призрак и воскрешает.") {
            ...
            textViewText.text =
                "Привет, я твой компаньон и я тебя воскресил по воле Странника. Странник посчитал что ты достоин его силы за твою прошлую жизнь. За твою храбрость, жертвенность."
            ...
            imageViewRole.setImageResource(R.drawable.ghost)
            textViewText.text = "Ну пошли тогда"
            textViewRole.text = "Призрак:"
        }
        else if (textViewText.text == "Ну пошли тогда") {
            imageViewRole.setImageResource(R.drawable.author)
            textViewText.text =
                "Пройдя по космодрому они наткнулись на ловушку, в которой их застали падшие, заметив на корабле."
            textViewRole.text = "Диктор:"
            layoutGame?.setBackgroundResource(R.drawable.cosmodrome2)
        }
        else if (textViewText.text == "Пройдя по космодрому они наткнулись на ловушку, в которой их застали падшие, заметив на корабле.") {
            imageViewRole.setImageResource(R.drawable.gvardianark)
            textViewText.text =
                "И в этот момент у нашего стража проявляются силы, которые помогли им отбиться от нападения. И он узнаёт, что обладает силой стихий и это - сила солнца, электричества и безгранной пустоты."
            textViewRole.text = "Диктор:"
        }
        else if (textViewText.text == "И в этот момент у нашего стража проявляются силы, которые помогли им отбиться от нападения. И он узнаёт, что обладает силой стихий и это - сила солнца, электричества и безгранной пустоты.") {
            imageViewRole.setImageResource(R.drawable.author)
        ...
        {
            imageViewRole.setImageResource(R.drawable.author)
            textViewText.text = "Он, кивнув головой сняли шлем"
            textViewRole.text = "Диктор:"
            buttonClick.visibility = View.INVISIBLE
        }
        else if (textViewText.text =="Он, кивнув головой сняли шлем")
        {
            imageViewRole.setImageResource(R.drawable.author)
            textViewText.text = "После снятия шлема их осмотрели и оставили в покое.И они заприметили висящий в складе корабль."
            textViewRole.text = "Диктор:"
        }
        else if (textViewText.text =="После снятия шлема их осмотрели и оставили в покое.И они заприметили висящий в складе корабль.")
        {
            imageViewRole.setImageResource(R.drawable.ghost)
        ...
        else if (textViewText.text =="Сколько тот корабль стоит?")
        {
            ...
            textViewText.text = "Он практически нечего не стоит, а что нужно для него и как починить уже другой разговор. Если вы нам поможете в наших делах, то я готов предоставить нужные детали и помочь починить его."
            textViewRole.text = "Незнакомец"
            buttonClick.text="Пригрозить"
            buttonClick.visibility = View.VISIBLE
        }
        else if (textViewText.text =="Он практически нечего не стоит, а что нужно для него и как починить уже другой разговор. Если вы нам поможете в наших делах, то я готов предоставить нужные детали и помочь починить его.")
        {
            imageViewRole.setImageResource(R.drawable.author)
        ...
        {
            imageViewRole.setImageResource(R.drawable.author)
            textViewText.text = "Однако, не что не вечно. В один ясный солнечный день, солнце стал закрывать большой космический корабль, который спустя время стал стримиться к Страннику на таран."
            textViewRole.text = "Диктор:"
            layoutGame?.setBackgroundResource(R.drawable.drednout)
        }
        else if (textViewText.text == "Однако, не что не вечно. В один ясный солнечный день, солнце стал закрывать большой космический корабль, который спустя время стал стримиться к Страннику на таран.")
        {
            imageViewRole.setImageResource(R.drawable.zavala)
            textViewText.text = "ВСЕМ ПО МЕСТАМ! ЗА ОРУДИЯ! БУДЕМ ГОТОВИТЬСЯ К БИТВЕ!"
            textViewRole.text = "Завала:"
            layoutGame?.setBackgroundResource(R.drawable.menu)
        }
        else if (textViewText.text =="ВСЕМ ПО МЕСТАМ! ЗА ОРУДИЯ! БУДЕМ ГОТОВИТЬСЯ К БИТВЕ!")
            {
                imageViewRole.setImageResource(R.drawable.author)
        ...
        {
            imageViewRole.setImageResource(R.drawable.ghost)
            textViewText.text = "Нам нужно что-то делать! Иначе странник не сможет отбиться и всему конец, в котором нас окутает тьма."
            textViewRole.text = "Призрак:"
            layoutGame?.setBackgroundResource(R.drawable.menu)
        }
        else if (textViewText.text == "Нам нужно что-то делать! Иначе странник не сможет отбиться и всему конец, в котором нас окутает тьма.")
        {
            imageViewRole.setImageResource(R.drawable.zavala)
            textViewText.text = "Я знаю ещё воителей света, которые смогу нам помочь, но так как у нас корабль один, полетишь ты страж, мы будем отбивать ферму от всякой нечисти."
            textViewRole.text = "Завала:"
            buttonClick.text="Убежать"
            buttonClick.visibility = View.VISIBLE
        }
        else if (textViewText.text == "Я знаю ещё воителей света, которые смогу нам помочь, но так как у нас корабль один, полетишь ты страж, мы будем отбивать ферму от всякой нечисти.")
        {
            imageViewRole.setImageResource(R.drawable.author)
        ...
        else if (textViewText.text == "Я была ученицей Осириса, и он рассказывал, что должен быть в Бесконечном лесу – это временной портал, который показывает разные варианты нашей вселенной и Вексы пробравшись сюда пытаются найти то будущее, в которой есть только они - завоеватели. И зайдя в портал главное не потеряться!")
        {
            ...
            textViewText.text = "Зайдя в портал пройдя мимо разных вариантов вселенной, они ужаснулись от одного, в котором наша земля была окутана тьмой и был таинственный голос, который говорил: “Свет — это угроза, а тьма – это спасение!”. "
            textViewRole.text = "Диктор:"
            layoutGame?.setBackgroundResource(R.drawable.forestin)
        }
        else if (textViewText.text == "Зайдя в портал пройдя мимо разных вариантов вселенной, они ужаснулись от одного, в котором наша земля была окутана тьмой и был таинственный голос, который говорил: “Свет — это угроза, а тьма – это спасение!”. "
        )
        {
            imageViewRole.setImageResource(com.example.yourdestiny.R.drawable.author)
        ...
        {
            imageViewRole.setImageResource(com.example.yourdestiny.R.drawable.author)
            textViewText.text = "После приземления они отметили победу. Осирис, взяв ученицу и полетели обратно в Бесконечный лес. Оставшиеся вместе с остальными стали строить у Странника город и стены вокруг него. И после постройки города и стены, стали хорошо жить, и ещё безопасней. "
            textViewRole.text = "Диктор:"
            layoutGame?.setBackgroundResource(R.drawable.gorod)
        }
        else if (textViewText.text == "После приземления они отметили победу. Осирис, взяв ученицу и полетели обратно в Бесконечный лес. Оставшиеся вместе с остальными стали строить у Странника город и стены вокруг него. И после постройки города и стены, стали хорошо жить, и ещё безопасней. ")
        {
            imageViewRole.setImageResource(com.example.yourdestiny.R.drawable.author)
    ...
    fun clickOnClickEndGame(view: View) {
        ...
        else if (buttonClickEnd.text=="Убежать")
        {
            buttonClickEnd.text = "Вернуться в меню"
            textViewRole.text = "Диктор:"
            textViewText.text = "Вы убежали и бросили их. Они не смогли одолеть корабль, корабль врезался в страника, отключив его свет и пришла тьма на нашу землю"
            imageViewRole.setImageResource(R.drawable.deadghost)
        ...
        else if (buttonClickEnd.text=="В бой!")
        {
            buttonClickEnd.text = "Вернуться в меню"
            textViewRole.text = "Диктор:"
            textViewText.text = "Вы подумали, что у вас хватит боевой мощности. Но это не так и вас уничтожили... Люди не смогли одолеть корабль на земле, корабль врезался в страника, отключив его свет и пришла тьма на нашу землю"
            imageViewRole.setImageResource(R.drawable.deadghost)
            layoutGame?.setBackgroundResource(R.drawable.night)
            buttonClick.visibility = View.INVISIBLE
        }
        else if (buttonClickEnd.text == "Стратегия одиночек")
        {
            buttonClickEnd.text = "Вернуться в меню"
            textViewRole.text = "Диктор:"
            textViewText.text = "Вы выбрали каждый сам за себя, и погибли, оставив человечество на вымирание"
            imageViewRole.setImageResource(R.drawable.deadghost)
            layoutGame?.setBackgroundResource(R.drawable.night)
            buttonClick.visibility = View.INVISIBLE
        }
